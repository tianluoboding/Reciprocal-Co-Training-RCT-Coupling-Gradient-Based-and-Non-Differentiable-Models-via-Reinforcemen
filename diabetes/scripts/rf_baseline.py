...
# -*- coding: utf-8 -*-
"""
RF-Only Baseline for Diabetes (BRFSS 2015) Dataset
...
def main():
    parser = argparse.ArgumentParser(description="RF-only baseline for Diabetes")
    ...
    print("=" * 80)
    print(f"RF-Only Baseline: Diabetes (BRFSS 2015) Dataset  [k={k}]")
    print("=" * 80)
