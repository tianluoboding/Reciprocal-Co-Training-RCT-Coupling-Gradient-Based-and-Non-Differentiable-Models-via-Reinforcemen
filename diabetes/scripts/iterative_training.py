...
# -*- coding: utf-8 -*-
"""
Iterative Training Loop V3 for Diabetes (BRFSS 2015) Dataset
...
USAGE:
======
python 12_iterative_training_v3.py                    # k=21 (default)
python 12_iterative_training_v3.py --k 10             # k=10 features
...
class IterativeConfig:
    ...
    # Feature selection
    k: int = 21  # k-best features (30 = all features, baseline)
    
    # PPO Training Config (from 58/60)
    ppo_num_epochs: int = 50
    ppo_samples_per_epoch: int = 2000  # Smaller dataset, fewer samples
...
def load_data(cfg: IterativeConfig):
    ...
    print(f"  ✓ Dataset: Diabetes (BRFSS 2015)")
...
def main():
    ...
    parser.add_argument('--k', type=int, default=21, choices=[5, 10, 21],
    ...
    print("=" * 80)
    print("ITERATIVE TRAINING LOOP V3: Diabetes (BRFSS 2015) Dataset")
    ...
    # V3 helper: extract train_sub / val / test data from embeddings
    ...
    print("=" * 80)
    print(f"Dataset: Diabetes (BRFSS 2015), k={cfg.k}")
