...
# -*- coding: utf-8 -*-
"""
LLM Cross-Entropy Baseline for MS-Relapse Dataset
...
def main():
    ...
    print("=" * 80)
    print("LLM Cross-Entropy Baseline: MS-Relapse Dataset")
    print("=" * 80)
    ...
    n_pos = y_all[train_sub_idx].sum()
    n_neg = len(train_sub_idx) - n_pos
    ce_weight = torch.tensor([1.0, n_neg / n_pos], dtype=torch.float32, device=DEVICE)
